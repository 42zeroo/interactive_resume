...
import styles from "@styles/layout/CircleLinesMouseMoveBackgroundAnimation.module.scss";

if (typeof window !== "undefined") window.$ = window.jQuery = require("jquery");

//https://codepen.io/Cyber-host/pen/yaeeOy

var backgroundAnimation = function (canvasRef) {
  var width,
    height,
    largeHeader,
    ctx,
...
const CircleLinesMouseMoveBackgroundAnimation = () => {
  const canvasRef = useRef();
  useEffect(() => {
    backgroundAnimation(canvasRef);
  }, []);
  return <canvas className={styles.container} ref={canvasRef}></canvas>;
};

export default CircleLinesMouseMoveBackgroundAnimation;
